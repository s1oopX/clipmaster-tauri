...
The current release line is `0.1.3`. The project already covers everyday clipboard history, link detection and opening, image history, region screenshots, frozen-screen selection, basic annotation, pinned desktop images, system tray behavior, settings, cleanup policies, data migration, and Windows packaging.
...
| File | Use case |
| --- | --- |
| `ClipMaster_0.1.3_x64-setup.exe` | Recommended installer for most Windows users |
| `ClipMaster_0.1.3_x64_en-US.msi` | MSI package for traditional deployment or environments that require MSI |
