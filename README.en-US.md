...
| File | Use case |
| --- | --- |
| `ClipMaster_0.1.5_x64-setup.exe` | Recommended installer for most Windows users |
| `ClipMaster_0.1.5_x64_en-US.msi` | MSI package for traditional deployment or environments that require MSI |
