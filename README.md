...
当前版本线为 `0.1.5`。项目已经覆盖日常可用的剪贴板历史、链接识别与打开、图片历史、区域截图、冻结屏幕选区、基础标注、桌面贴图、全局快捷键、系统托盘、设置、清理策略、数据迁移和 Windows 打包流程。
...
| 文件 | 适用场景 |
| --- | --- |
| `ClipMaster_0.1.5_x64-setup.exe` | 推荐安装包，适合大多数 Windows 用户 |
| `ClipMaster_0.1.5_x64_en-US.msi` | MSI 安装包，适合传统部署、企业环境或需要 MSI 的场景 |
