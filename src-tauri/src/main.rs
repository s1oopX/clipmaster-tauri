...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            commands::history_commands::get_clipboard_items,
            commands::history_commands::get_items_by_day,
            commands::history_commands::get_available_days,
            commands::history_commands::get_items_by_session,
            commands::history_commands::delete_item,
            commands::history_commands::toggle_favorite,
            commands::history_commands::toggle_pinned,
            commands::history_commands::get_current_session,
            commands::history_commands::get_sessions,
            commands::history_commands::clear_session,
            commands::history_commands::search_items,
            commands::history_commands::update_item_content,
            commands::history_commands::update_item_annotation,
            ...
            commands::window_commands::pin_image,
        ])
        .build(context)
